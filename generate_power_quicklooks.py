#!/usr/bin/env python3
"""Generate grouped daily and latest power quicklook PNGs."""
...
def main(force: bool = False) -> None:
    ...
    if force:
        ...
        print("Deleted existing grouped power quicklook PNGs.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate grouped power quicklook PNGs")
