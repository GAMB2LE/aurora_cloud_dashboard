...
SUMMARY_LAYOUTS: dict[str, tuple[PanelSpec, ...]] = {
    ...
    "ops-monitor-hk": (
        PanelSpec(
            ...
            None,
            (
                TraceSpec("host_celine_source_used_pct", "CL61 Source Disk", COLOR["teal"]),
                TraceSpec("host_ass_data_used_pct", "ASS Data Disk", COLOR["blue"]),
                TraceSpec("host_aps_source_used_pct", "APS Source Disk", COLOR["brown"]),
