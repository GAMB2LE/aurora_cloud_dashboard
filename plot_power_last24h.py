#!/usr/bin/env python3
"""Render Aurora Power Supply housekeeping latest-24h PNGs."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render Aurora Power Supply housekeeping latest-24h PNGs")
